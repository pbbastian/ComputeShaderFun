...
namespace Plugins.Editor.JetBrains
{
  ...
  {
      const string UNITY_PLAYER_PROJECT_NAME = "Assembly-CSharp.csproj";
      const string UNITY_EDITOR_PROJECT_NAME = "Assembly-CSharp-Editor.csproj";
      const string UNITY_UNSAFE_KEYWORD = "-unsafe";
      const string UNITY_DEFINE_KEYWORD = "-define:";
      const string PLAYER_PROJECT_MANUAL_CONFIG_RELATIVE_FILE_PATH = "smcs.rsp";
      static readonly string  PLAYER_PROJECT_MANUAL_CONFIG_ABSOLUTE_FILE_PATH
      = Path.Combine(UnityEngine.Application.dataPath, PLAYER_PROJECT_MANUAL_CONFIG_RELATIVE_FILE_PATH);
      const string EDITOR_PROJECT_MANUAL_CONFIG_RELATIVE_FILE_PATH = "gmcs.rsp";
      static readonly string  EDITOR_PROJECT_MANUAL_CONFIG_ABSOLUTE_FILE_PATH
      = Path.Combine(UnityEngine.Application.dataPath, EDITOR_PROJECT_MANUAL_CONFIG_RELATIVE_FILE_PATH);

      static readonly int unityProcessId = Process.GetCurrentProcess().Id;
      ...
      static void UpgradeProjectFile(string projectFile)
    {
      ...
      static void SetUnityData(XElement projectElement, XNamespace xmlns)
    {
      ...
      static void SetManuallyDefinedComilingSettings(string projectFile, XElement projectContentElement, XNamespace xmlns)
    {
      string configPath;
      ...
      static void ApplyManualCompilingSettings(string configFilePath, XElement projectContentElement, XNamespace xmlns)
    {
      ...
      static void ApplyCustomDefines(string[] customDefines, XElement projectContentElement, XNamespace xmlns)
    {
      ...
      static void FixTargetFrameworkVersion(XElement projectElement, XNamespace xmlns)
    {
      ...
      static void SetLangVersion(XElement projectElement, XNamespace xmlns)
    {
      ...
      static string GetLanguageLevel()
    {
      ...
      static void SetXCodeDllReference(string name, XNamespace xmlns, XElement projectContentElement)
    {
