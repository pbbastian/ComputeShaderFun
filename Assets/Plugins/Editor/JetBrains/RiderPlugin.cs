...
namespace Plugins.Editor.JetBrains
{
  ...
  public static class RiderPlugin
  {
    ...
    static void UpdateUnitySettings(string slnFile)
    {
      try
      {
    ...
    static bool OnOpenedAsset(int instanceID, int line)
    {
      ...
      static bool CallUDPRider(int line, string slnPath, string filePath)
    {
      ...
      static void CallRider(string riderPath, string args)
    {
      ...
      static void ActivateWindow(string riderPath)
    {
